...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('order', models.PositiveSmallIntegerField(help_text='The order-by field per-game. You can have the same ordering value for memes but this may have unpredictable results. This field is automatically set to N+1 if col_00 as 0.')),
            ],
            options={
                'ordering': ['order'],
            },
