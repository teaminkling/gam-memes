    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('max_rounds', models.PositiveSmallIntegerField(help_text='The total number of rounds and the final round.', validators=[django.core.validators.MaxValueValidator(128), django.core.validators.MinValueValidator(1)], verbose_name='Maximum Rounds')),
                ...
                ('meme_templates', models.ManyToManyField(through='data_mine.MemeTemplateToGameThrough', to='data_mine.MemeTemplate')),
            ],
        ),
        migrations.CreateModel(
            name='Player',
