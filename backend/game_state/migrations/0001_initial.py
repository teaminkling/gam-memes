...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='game',
            name='vip',
            field=models.ForeignKey(help_text='The VIP of this game that can modify the settings.', on_delete=django.db.models.deletion.CASCADE, related_name='game_vip_player', to='game_state.player'),
        ),
    ]
